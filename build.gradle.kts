            ...
            publications {
                withType<MavenPublication> {
                    pom {
                        ...
                        scm {
                            connection.set("scm:git@github.com:metaborg/spoofax3-depman.git")
                            developerConnection.set("scm:git@github.com:metaborg/spoofax3-depman.git")
                            url.set("scm:git@github.com:metaborg/spoofax3-depman.git")
                        }
                    }
                }
            }
